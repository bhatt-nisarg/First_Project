...
public class restaurent_clicked extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new RestaurentClicked().execute(AppConstants.CLICKED_CATEGORY_DATA,AppConstants.CLICKED_REGION_SINGLE_LIST);
...
//            }
        ...
        protected void onPostExecute(String s) {
            ...
            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(restaurent_clicked.this);
